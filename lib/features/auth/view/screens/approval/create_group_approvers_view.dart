...
class _CreateGroupApproverView extends State<CreateGroupApproverView> {
  ...
  Future<void> fetchGroupApprovalDetails() async {
    setState(() {
      isLoading = true;
      isError = false;
    });
  ...
  Future<void> saveGroupApprovalDetails() async {
    setState(() {
      isLoading = true;
      isError = false;
    });
